...
# Module-level assignment --- required for `fastapi dev` auto-discovery
app = create_app()
```

The `app = create_app()` line at the bottom is what the FastAPI CLI discovers. In tests, call `create_app()` directly to get an isolated instance.
